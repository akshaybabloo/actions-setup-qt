...
function getInstallerConfig() {
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .debug */ .Yz)("Detected macOS platform");
    return {
...
async function mountDmg(dmgPath) {
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)("Mounting DMG file...");
    try {
        // Mount the DMG
        await (0,_actions_exec__WEBPACK_IMPORTED_MODULE_1__/* .exec */ .m)("hdiutil", ["attach", dmgPath, "-nobrowse"]);
        ...
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)(`DMG mounted at: ${mountPath}`);
        return mountPath;
    }
    catch (err) {
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)(`Failed to mount DMG: ${err}`);
        throw err;
    }
}
/**
...
async function unmountDmg(mountPath) {
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)("Unmounting DMG file...");
    try {
        await (0,_actions_exec__WEBPACK_IMPORTED_MODULE_1__/* .exec */ .m)("hdiutil", ["detach", mountPath]);
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)("DMG unmounted successfully");
    }
    catch (err) {
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)(`Failed to unmount DMG: ${err}`);
    }
}
/**
...
async function findMacInstaller(mountPath) {
    try {
        ...
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)(`Files in mount path: ${files.join(", ")}`);
        // Find the .app file
        const appFile = files.find((file) => file.endsWith(".app"));
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)(`Found .app file: ${appFile}`);
        if (!appFile) {
        ...
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)(`Contents/MacOS files: ${contentsDir.join(", ")}`);
        const executable = contentsDir.find((file) => file.includes("qt-unified-macOS") || file.includes("qt-online-installer"));
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)(`Found executable: ${executable}`);
        if (!executable) {
        ...
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)(`Found installer executable: ${executablePath}`);
        return executablePath;
    }
    catch (err) {
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)(`Failed to find Mac installer: ${err}`);
        throw err;
    }
}
/**
...
async function setupDependencies() {
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)("Checking Xcode installation...");
    try {
        // Check if Xcode command line tools are installed
        await (0,_actions_exec__WEBPACK_IMPORTED_MODULE_1__/* .exec */ .m)("xcode-select", ["-p"]);
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)("Xcode command line tools already installed");
    }
    catch (err) {
        (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)("Installing Xcode command line tools...");
        try {
            await (0,_actions_exec__WEBPACK_IMPORTED_MODULE_1__/* .exec */ .m)("xcode-select", ["--install"]);
            (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)("Xcode command line tools installed successfully");
        }
        catch (installErr) {
            (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .error */ .z3)(`Failed to install Xcode command line tools: ${installErr}`);
            throw installErr;
        }
    }
}
