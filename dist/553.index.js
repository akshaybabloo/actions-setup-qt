...
function getInstallerConfig() {
    ...
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .debug */ .Yz)(`Detected Windows platform, architecture: ${arch}`);
    if (arch === "arm64") {
        return {
...
async function setupDependencies() {
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)("Windows MSVC environment will be set up separately using TheMrMilchmann/setup-msvc-dev@v4");
    (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__/* .info */ .pq)("Please ensure you have added the setup-msvc-dev action before this action in your workflow");
}
/**
